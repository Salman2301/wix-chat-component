...
(function () {
	...
	var jquery_timeago = createCommonjsModule(function (module) {
	/**
...
`;
	class MessagesComponent extends HTMLElement {
	    ...
	    _formatMsgHTML(msg) {
	        ...
	        msg.timeAgoStr = jquery_timeago.format(msg.date);
	    ...
	    _updateTimeAgo() {
	        this.interval = setInterval(() => {
	            Array.prototype.slice.call(this.$container.children).forEach(el=>{
	                ...
	                timeAgoEl.textContent = jquery_timeago.format(datetime);
	            });
